...
(cl:defmethod cl:initialize-instance :after ((m <UAVState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'UAVState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mission_planner1-msg:<UAVState> is deprecated: use mission_planner1-msg:UAVState instead.")))

(cl:ensure-generic-function 'UAV_state-val :lambda-list '(m))
(cl:defmethod UAV_state-val ((m <UAVState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mission_planner1-msg:UAV_state-val is deprecated.  Use mission_planner1-msg:UAV_state instead.")
  (UAV_state m))

(cl:ensure-generic-function 'UAV_pose-val :lambda-list '(m))
(cl:defmethod UAV_pose-val ((m <UAVState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mission_planner1-msg:UAV_pose-val is deprecated.  Use mission_planner1-msg:UAV_pose instead.")
  (UAV_pose m))

(cl:ensure-generic-function 'UAV_velocity_body-val :lambda-list '(m))
(cl:defmethod UAV_velocity_body-val ((m <UAVState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mission_planner1-msg:UAV_velocity_body-val is deprecated.  Use mission_planner1-msg:UAV_velocity_body instead.")
  (UAV_velocity_body m))
