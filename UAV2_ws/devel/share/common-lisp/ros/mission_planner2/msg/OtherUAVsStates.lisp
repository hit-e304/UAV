...
(cl:in-package mission_planner2-msg)
...
(cl:defclass <OtherUAVsStates> (roslisp-msg-protocol:ros-message)
  ((other_UAVs_state
    ...
    :type (cl:vector mission_planner2-msg:UAVState)
   :initform (cl:make-array 0 :element-type 'mission_planner2-msg:UAVState :initial-element (cl:make-instance 'mission_planner2-msg:UAVState))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <OtherUAVsStates>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'OtherUAVsStates)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mission_planner2-msg:<OtherUAVsStates> is deprecated: use mission_planner2-msg:OtherUAVsStates instead.")))

(cl:ensure-generic-function 'other_UAVs_state-val :lambda-list '(m))
(cl:defmethod other_UAVs_state-val ((m <OtherUAVsStates>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mission_planner2-msg:other_UAVs_state-val is deprecated.  Use mission_planner2-msg:other_UAVs_state instead.")
  (other_UAVs_state m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <OtherUAVsStates>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'other_UAVs_state)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'mission_planner2-msg:UAVState))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<OtherUAVsStates>)))
  ...
  "mission_planner2/OtherUAVsStates")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'OtherUAVsStates)))
  "Returns string type for a message object of type 'OtherUAVsStates"
  "mission_planner2/OtherUAVsStates")
